...
class Rectangle {
private:
	int x1,x2,x3,x4,y1,y2,y3,y4,length,perimeter,area,width;
...
public:
	...
	void setPoint(int p1x, int p2x, int p3x, int p4x , int p1y, int p2y, int p3y, int p4y)
	{
		...
		else if (p2x >= 0 && p2x <= 20)
		{
			x2 = p2x;
		} 
		else if (p3x >= 0 && p3x <= 20)
		{
			x3 = p3x;
		} 
		else if (p4x >= 0 && p4x <= 20)
		{
			x4 = p4x;
		}
		else if (p1y >= 0 && p1y <= 20)
		{
			y1 = p1y;
		}
		else if (p2y >= 0 && p2y <= 20)
		{
			y2 = p2y;
		} 
		else if (p3y >= 0 && p3y <= 20)
		{
			y3 = p3y;
		}
	    else if (p4x >= 0 && p4x <= 20)
        ...
        else if (x1 == x4 && y1 == y2 && x3 == x2 && y3 == y4)
		{
